...
function HomePage() {
  ...
  return (
    <div className="h-screen w-screen overflow-auto bg-neutral-950 text-white">
      {/* Hero Section */}
      ...
      {/* Cards Section */}
      <section className="m-auto grid max-w-6xl grid-cols-1 gap-6 px-6 pb-12 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
